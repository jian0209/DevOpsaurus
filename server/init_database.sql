...
CREATE TABLE `d_user_info` (
  ...
  `mfa_status` int DEFAULT 0 NOT NULL COMMENT 'mfa status, 0: disable, 1: enable',
  `is_mfa_enable` int DEFAULT 0 COMMENT 'mfa enable status, 0: disable, 1: enable',
  `is_password_force_reset` int DEFAULT 0 COMMENT 'password force reset status, 0: disable, 1: enable',
...
CREATE TABLE `d_login_log` (
  ...
  `last_login_ip` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'last login ip',
