...
class Config(object):
    ...
    REDIS_URL = f"redis://{os.getenv('REDIS_USERNAME', '')}:{os.getenv('REDIS_AUTH', 'V')}@{os.getenv('REDIS_HOST', '192.168.10.21')}:{os.getenv('REDIS_PORT', '6379')}/0"
    ...
    LOG_PATH = os.getenv(
        "LOG_PATH", "/Users/nicholas/Documents/my-project/DevOpsaurus/server/logs/")
